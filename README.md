...
**版本**: v0.9.9a（右下角顯示，由 package.json 自動注入）
...
| 等級 | 效果 | 升級說明 |
|------|------|----------|
| Lv.0 | 2 單位範圍、2 傷害 | 你參透了互動設計的原理，同時了解遊戲企劃架構 |
| Lv.1 | 2.5 單位範圍、4 傷害 | 你習得動作捕捉的技術，將應用到虛擬實境製作 |
| Lv.2 | 3 單位範圍、6 傷害 | 你增進了程式設計能力和遊戲引擎的創作能力 |
| Lv.3 | 3.5 單位範圍、8 傷害 | 你整合了虛擬網紅製作技術，讓自媒體營銷具爆發力 |
| Lv.4 | 4 單位範圍、10 傷害 | 你導入了人工智慧協作能力，產能提升了數倍 |
| MAX | 4.5 單位範圍、12 傷害 | 你成為了遊戲先知，解鎖了進階技能組合 |
