...
**版本**: v0.9.0a（右下角顯示，由 package.json 自動注入）
...
| 幻影迭代模式 | 咒言幻象（遊戲先知）+ AI 賦能強化 | 15 秒 | 召喚半透明紫色影分身，施放燃燒賽璐珞(3 單位)、技美大神(2 發)、完美像素(±2 單位)，嘲諷怪物，本尊與分身間每 0.5 秒彈射射線 |
